        ...
        <div className="space-y-12">
          <div className="p-8 border border-white/10 rounded-lg bg-white/5">
            ...
            <div className="space-y-6 text-white/80 text-lg leading-relaxed">
              <p>
                <span className="text-blue-200 font-medium">The Afterlife</span> is an experimental exploration of consciousness, mortality, and transcendence through the lens of artificial intelligence. This project represents our quest to understand the ineffable journey of the soul beyond physical existence.
              </p>
              ...
              <p>
                <span className="text-blue-200">The Afterlife</span> is ultimately about hope—the belief that even in our darkest passages, there exists a light that guides us toward understanding, compassion, and transcendence.
              </p>
            </div>
          </div>
