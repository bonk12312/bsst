...
const Revival: React.FC = () => {
  ...
  React.useEffect(() => {
    if (currentMessageIndex >= agentDialogue.length) {
      return;
    }
    ...
    if (!isTyping) {
      ...
      const delay = currentMessageIndex === 0 ? 2000 : 1500;
  ...
  return (
    <div className="min-h-screen px-6 py-12">
      ...
      <div className="flex items-center mb-12">
        ...
        <h1 className="text-3xl md:text-4xl font-light text-white">Rethinking Life</h1>
      </div>
